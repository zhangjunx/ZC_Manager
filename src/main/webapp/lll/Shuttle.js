...
layui.use(['tree', 'util'], function(){
  ...
  $.ajax({
	  ...
	  success:function(data){
		  console.log(data)
	  	 console.log( getTree(data.result))
			     ...
			     success:function(data){
			    	 ...
			    	 if(data.flag){
			    		 ...
			    		 $.each(data.result,function(i,val){
							 ...
							 html+="<li><img src='img/g.png'><h5><p class='username' id='"+val.holderno+"'>"+holdername+"</p><p>"+departmentname+"</p></h5><span class='checkbox'  style='float: none;'></span></li>";
			    		 })
