                ...
                switch (msgJson.fun) {
                    ...
                    case "EST_Reader_ReadIDCard#":
                        if (msgJson.rCode == "0") {
                        	clearInterval(timer);
                        		$.ajax({
                        			//url:url+"/WX_VisitorsInfo/queryVisitorsInfoByUnaudited",
                        			url:url+"/WX_VisitorsInfoAdd/queryVisitorsInfoByUnaudited",
                        			type:"POST",
                        			data:{"str":msgJson.certNo,"strr":"2"},
                        			//data:{"str":msgJson.certNo},
                        			dataType:"json",
                        			success:function(data){//刷身份证
                        				console.log(data);
                    					...
                    					for(var i=0;i<res.length;i++){
                    						...
                    						if(res[i].visitorstype=="C"){
                        						...
                        						var applystatusname=(res[i].arrlist[0].applystatusname==undefined)?"":res[i].arrlist[0].applystatusname;
                        						
                        						var $div1=$("<div class='approval_pending'></div>")
                        						var $div2=$("<div class='scroll_approvalPending'><ul class='vehicleInfo'><li><label>车牌号码:</label><span class='vehicle_number'>"+carinfo+"</span></li>" +
                        								"<li><label>车牌类型:</label><span class='vehicle_type'>"+dringmodels+"</span></li><li><label>车身颜色:</label><span class='vehicle_color'>"+note+"</span></li></ul><dl>" +
                        								"<dt class='infor_left'><img src='data:image/png;base64,"+res[i].arrlist[0].policephoto
                        						...
                        						var $div3=$("<div class='approval_tit'></div>");
                        						var $h4=$("<h4 class='approval_status'>车辆|"+approvertypename+"|"+applystatusname+"</h4>");
                        						var $p=$("<p class='apply_time'>申请时间:<span>"+filldate+"</span></p>");
                        						var $div4=$("<div class='approval_process'></div>");
                        						var $span1=$("<span class='refer'><img src='img/complete.png'> 提交</span>");
                        						var $span2=$("<span class='line'></span>");
                        						var $span3=$("<span class='approval'><img src='img/wait.png'>"+res[i].arrlist[0].approverrolename1+"</span>");
                        						var $span4=$("<span class='line'></span>");
                        						var $span5=$("<span class='approval'><img src='img/wait.png'>"+res[i].arrlist[0].approverrolename2+"</span>");
                        						var $span6=$("<span class='line'></span>");
                        						var $span7=$("<span class='approval'><img src='img/wait.png'>完成</span>");
                        						$div4.append($span1);
                        						$div4.append($span2);
                        						$div4.append($span3);
                        						$div4.append($span4);
                        						...
                        						$div4.append($span6);
                        						$div4.append($span7);
                        						if(res[i].applystatus=="20"){
                        							if(res[i].approverrolename==res[i].arrlist[0].approverrolename1){
                        								$span2.css("background","#4AA5F5");
                            							$span3.find("img").attr("src","img/complete.png");
                        							}else{
                        								$span4.css("background","#4AA5F5");
                            							$span5.find("img").attr("src","img/complete.png");
                        							}
                        						}
                    						...
                    						}else if(res[i].visitorstype=="P"){//人员登记
                        						//警察信息
                        						var departmentsname=(res[i].arrlist[0].departmentsname==undefined)?"":res[i].arrlist[0].departmentsname;
                        						var filldate=(res[i].arrlist[0].filldate==undefined)?"":res[i].arrlist[0].filldate;
                        						var filltime=(res[i].arrlist[0].filltime==undefined)?"":res[i].arrlist[0].filltime;
                        						...
                        						var $div3=$("<div class='approval_tit'></div>");
                        						var $h4=$("<h4 class='approval_status'>人员|"+approvertypename+"|"+applystatusname+"</h4>");
                        						var $p=$("<p class='apply_time'>申请时间:<span>"+filldate+"</span></p>");
                        			...
                        			success:function(data){//刷卡
                        				...
                        				for(var i=0;i<res.length;i++){
                    						...
                    						if(res[i].visitorstype=="C"){
                        						...
                        						var receiverpeopleid=(res[i].arrlist[0].receiverpeopleid==undefined)?"":res[i].arrlist[0].receiverpeopleid;
                        						var receiversname=(res[i].arrlist[0].receiversname==undefined)?"":res[i].arrlist[0].receiversname;
                        						var applystatusname=(res[i].arrlist[0].receiversname==undefined)?"":res[i].arrlist[0].applystatusname;
                        						var $div1=$("<div class='approval_pending'></div>")
                        						var $div2=$("<div class='scroll_approvalPending'><ul class='vehicleInfo'><li><label>车牌号码:</label><span class='vehicle_number'>"+carinfo+"</span></li>" +
                        								"<li><label>车牌类型:</label><span class='vehicle_type'>"+dringmodels+"</span></li><li><label>车身颜色:</label><span class='vehicle_color'>"+note
                        								...
                        								+receiverpeopleid+"</span></dd><dd><label class='pliceName'>姓名:</label><span class='receiversname'>"
                        								+receiversname+"</span></dd><dd><label class='prison'>部门:</label><span class='jianQu'>"+departmentsname
