...
function querySupplier(){
	...
	$.ajax({
		...
		type:"POST",
		data:{"type":"b","companycode":companycode,"companyname":companyname},
				...
				for(var i=0;i<res.length;i++){
					...
					var bankcard=(res[i].bankcard==undefined?"":res[i].bankcard);
					 ...
					 if(list.findIndex(target=>target.Code=="update")==-1&&window.top.arr.length!=0){
						 ...
						 var text1="<a href='b_supplier_add.html?datano="+res[i].datano+"' class='mo layui-btn layui-btn-xs'>修改</a>";
					  }
