$(function(){
	...
	function queryOneApply(){
		$.ajax({
			...
			type:"POST",
			data:{"themeno":localStorage.themeno4},
			success:(data)=>{
				//console.log(data);
				if(data.flag){
					var res=data.result;
	...
	//点击调休申请中的确定
	$("#updateIntermission").click(function(){
		...
		var obj={"holderno":holderno,"departmentno":departmentno,"begintime":begintime,"endtime":endtime,"firstapproval":arr,"remark":remark,"themeno":localStorage.themeno4}
