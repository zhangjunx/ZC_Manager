...
import com.xr.dao.ZC_SupplierMapper;
import com.xr.service.ZC_SupplierService;

@Service
public class ZC_SupplierServiceImpl implements ZC_SupplierService {
	
	@Autowired
	private ZC_SupplierMapper supplierMapper;
	...
	public Map<String, Object> getList(Map<String, Object> map) {
		...
		List<Map<String,Object>> list = supplierMapper.getList(map);
		int count = supplierMapper.getListCount(map);
		if(count>0){
	...
	public Map<String, Object> saveInfo(Map<String, Object> map) {
		Map<String,Object> resultMap = new HashMap<String, Object>();
		//参数验证
		Map<String,Object> checkInfo = supplierMapper.getSumWithName(map);//生产厂家名称验证
		//Map<String,Object> checkInfo2 = supplierMapper.getSumWithName2(map);//供应厂商名称验证
		if(checkInfo != null){
		...
		if(map.get("fid") == null || map.get("fid").toString().equals("")){//新增
			b = supplierMapper.saveInfo(map);
		}else{//编辑
			b = supplierMapper.editInfo(map);
		}
	...
	public Map<String, Object> getOne(Map<String, Object> map) {
		...
		Map<String,Object> result = supplierMapper.getOne(map);
		if(result != null){
			resultMap.put("flag", true);
	...
	public Map<String, Object> delOne(Map<String, Object> map) {
		...
		int b = supplierMapper.delOne(map);
