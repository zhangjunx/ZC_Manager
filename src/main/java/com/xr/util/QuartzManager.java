...
public class QuartzManager {  
    ...
    public static void addJob(Scheduler sched, String jobName,  
            @SuppressWarnings("rawtypes") Class cls, String time,Map<String,Object> mapParam) {  
        try {  
            ...
            jobDetail.getJobDataMap().put("mapParam", mapParam);
    ...
    public static void modifyJobTime(Scheduler sched, String jobName,  
        ...
        try {  
            ...
            if (!oldTime.equalsIgnoreCase(time)) {  
                ...
                addJob(sched, jobName, objJobClass, time,mapParam1);  
            }  
        } catch (Exception e) {  
            throw new RuntimeException(e);  
        }  
