				...
				if(data.flag){
					...
					for(var i=0;i<res.length;i++){
						...
						for(var k=0;k<res[i].child.length;k++){
							...
							$span2.append("最早打卡:"+res[i].child[k].workearliest);
							$span3.append("工作打卡:"+res[i].child[k].worktime);
							$span4.append("最晚打卡:"+res[i].child[k].worklatest);
							$div1.append($span1);
							$div1.append($span2);
							$div1.append($span3);
							$div1.append($span4);
