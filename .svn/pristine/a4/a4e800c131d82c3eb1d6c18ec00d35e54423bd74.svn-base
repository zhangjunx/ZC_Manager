					...
					for(var item of res[1].child){
						if(item.classno=="班段一"){
							if(item.sectionstatus=="上班"){
								...
								$("#workfirsttime").prev().val(item.whichearliest);
								$("#starttime").prev().val(item.whichwork);
								$("#worklasttime").prev().val(item.whichlatest);
								$("#checkbox1").click();
								...
								$("#leavefirsttime").prev().val(item.whichearliest);
								$("#endtime").prev().val(item.whichwork);
								$("#leavelasttime").prev().val(item.whichlatest);
								$("#checkbox2").click();
							...
							if(item.sectionstatus=="上班"){
								...
								$("#workfirsttime2").prev().val(item.whichearliest);
								$("#starttime2").prev().val(item.whichwork);
								$("#worklasttime2").prev().val(item.whichlatest);
								$("#checkbox3").click();
								...
								$("#leavefirsttime2").prev().val(item.whichearliest);
								$("#endtime2").prev().val(item.whichwork);
								$("#leavelasttime2").prev().val(item.whichlatest);
								$("#checkbox4").click();
							...
							if(item.sectionstatus=="上班"){
								...
								$("#workfirsttime3").prev().val(item.whichearliest);
								$("#starttime3").prev().val(item.whichwork);
								$("#worklasttime3").prev().val(item.whichlatest);
								$("#checkbox5").click();
								...
								$("#leavefirsttime3").prev().val(item.whichearliest);
								$("#endtime3").prev().val(item.whichwork);
								$("#leavelasttime3").prev().val(item.whichlatest);
								$("#checkbox6").click();
