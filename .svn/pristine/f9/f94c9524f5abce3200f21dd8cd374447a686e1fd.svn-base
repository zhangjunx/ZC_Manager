...
@Service
public class ProductStockDataServiceImpl implements IProductStockDataService {

	@Autowired
	private ProductStockDataMapper sdm;

	@Override
	public Map<String, Object> queryProductStockDataListService(ProductStockData sd,PageInfo pageinfo) {
		// 查询成品库存列表
		...
		List<Map<String,Object>> list=sdm.queryProductStockDataList(map1);
