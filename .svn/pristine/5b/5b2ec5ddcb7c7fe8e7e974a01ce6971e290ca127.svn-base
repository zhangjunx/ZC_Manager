...
function inStroageReviewed(){
	...
	var obj={"curpage":curpage,"pagesize":pagesize,"approvalResult":1,"thisHolderNo":window.top.holderno,"bill":bill,"inDate":inDate};
	console.log(obj);
	$.ajax({
...
function outStroageReviewed(){
	...
	var obj={"curpage":curpage,"pagesize":pagesize,"approvalResult":1,"thisHolderNo":window.top.holderno,"bill":bill,"outDate":outDate};
	$.ajax({
...
function borrowStroageReviewed(){
	...
	var obj={"curpage":curpage,"pagesize":pagesize,"approvalResult":1,"thisHolderNo":window.top.holderno,"bill":bill,"operateDate":operateDate};
	$.ajax({
